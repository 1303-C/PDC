            ...
            <div class="card card-teal">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" style="width: 100%;" id="Actividades"
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" style="width: 100%;" id="fecha_programada" name="fecha_programada" type="Date"
                                    required>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" style="width: 100%;" id="fecha_cierre" name="fecha_cierre" type="Date"
                                    required>
                            </div>
                        </div>
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <Select class="form-control col-lg-12" style="width: 100%;" id="ca_estado_id" name="ca_estado_id"
                                    required>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <select class="form-control" style="width: 100%;" id="porcentaje" name="porcentaje" required>
                                    <option value="">-Seleccione-</option>
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" style="width: 100%;" id="fecha_reprogramada" name="fecha_reprogramada" type="Date"
                                    required>
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-4">
                        ...
                        <div class="col-lg-5">
                            <div class="form-group">
                                <button type="submit" class="btn btn-block bg-gradient-primary" id="btn-editar-gerencia"
                                    style="display: none">Editar</button>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="form-group">
                                <button type="button" class="btn btn-block bg-gradient-danger" id="btn-cancelar-gerencia"
